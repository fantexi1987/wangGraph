...
export class wangConstants {
  ...
  static PAGE_FORMAT_A4_PORTRAIT = new wangRectangle(0, 0, 827, 1169);
  static PAGE_FORMAT_A4_LANDSCAPE = new wangRectangle(0, 0, 1169, 827);
  static PAGE_FORMAT_letTER_PORTRAIT = new wangRectangle(0, 0, 850, 1100);
  static PAGE_FORMAT_letTER_LANDSCAPE = new wangRectangle(0, 0, 1100, 850);
  static NONE = 'none';
